...
/** Ten iconic Oklahoma Sooners wins — national titles, upsets, and rivalry classics */
export const iconicGames: IconicGame[] = [
  {
    id: "2000-orange-bowl",
    title: "2000 BCS National Championship",
    nickname: "Perfect Season · 13-0",
    date: "January 3, 2000",
    ...
    tags: ["National Title", "BCS", "Undefeated"],
    description:
      "Bob Stoops' first season ended with a perfect 13-0 record and the BCS national championship. The Sooners held Florida State to a single safety — one of the most dominant defensive performances in title-game history — while Josh Heupel managed a gritty Orange Bowl win.",
    stats: [
  ...
  {
    id: "1974-sugar-bowl",
    title: "Switzer's First Title",
    nickname: "Sugar Bowl vs. Alabama",
    date: "January 2, 1975",
    opponent: "Alabama",
    location: "Tulane Stadium, New Orleans, LA",
    result: "W",
    score: "OU 14, Alabama 13",
    era: "Switzer Wishbone Era",
    tags: ["National Title", "Bowl", "Upset Drama"],
    description:
      "Barry Switzer's first national championship came in a nail-biter against Bear Bryant's Alabama. The Sooners' wishbone offense and suffocating defense held on for a one-point Sugar Bowl victory to cap an undefeated 11-0 season.",
    stats: [
      { label: "OU Record", value: "11-0" },
      { label: "Margin", value: "1 pt" },
      { label: "Joe Washington", value: "196 rush yds" },
      { label: "PPG (season)", value: "34.5" },
    ],
    image: "/legend-games/1974-sugar-bowl.png",
  },
  {
    id: "1975-orange-bowl",
    title: "Back-to-Back Champions",
    nickname: "Orange Bowl vs. Michigan",
    date: "January 1, 1976",
    opponent: "Michigan",
    location: "Orange Bowl, Miami, FL",
    result: "W",
    score: "OU 14, Michigan 6",
    era: "Switzer Wishbone Era",
    tags: ["National Title", "Bowl", "Repeat"],
    description:
      "OU repeated as national champions with a methodical Orange Bowl win over Michigan. Joe Washington's open-field brilliance and Lee Roy Selmon's defense carried Switzer's Sooners to back-to-back titles.",
    stats: [
      { label: "OU Record", value: "11-1" },
      { label: "Michigan Pts", value: "6" },
      { label: "Selmon", value: "Outland Trophy" },
      { label: "Washington", value: "1,990 rush yds" },
    ],
    image: "/legend-games/1975-orange-bowl.png",
  },
  {
    id: "1985-orange-bowl",
