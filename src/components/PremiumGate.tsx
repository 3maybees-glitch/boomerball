...
export function PremiumGate({ children }: PremiumGateProps) {
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-md rounded-2xl border border-crimson/25 bg-white p-6 text-center shadow-[0_12px_40px_rgba(132,22,23,0.15)] sm:p-8">
      ...
      <div className="relative mt-6 overflow-hidden rounded-2xl border border-crimson/20 bg-white/95 shadow-[0_8px_32px_rgba(26,10,10,0.08)]">
        <div className="pointer-events-none max-h-80 select-none overflow-hidden blur-sm sm:max-h-96">
          {children}
        </div>
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-cream via-cream/80 to-transparent"
          aria-hidden
        />
      </div>
    </div>
