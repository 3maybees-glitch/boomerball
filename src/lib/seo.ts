...
export const DEFAULT_DESCRIPTION =
  "Oklahoma Sooners football analytics for Sooner Nation — 2026 season stats through the Michigan loss, Monday Morning Quarterback recaps, roster, schedule, news, legends, and premium SP+ metrics. Sources cited from soonersports.com and ESPN.";
